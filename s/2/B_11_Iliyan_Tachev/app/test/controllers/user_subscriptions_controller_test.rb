...
class UserSubscriptionsControllerTest < ActionController::TestCase
  ...
  test "should create user_subscription" do
    assert_difference('UserSubscription.count') do
      post :create, user_subscription: { subscription_id: @user_subscription.subscription_id, type_of: @user_subscription.type_of, user_id: @user_subscription.user_id }
    end
  ...
  test "should update user_subscription" do
    patch :update, id: @user_subscription, user_subscription: { subscription_id: @user_subscription.subscription_id, type_of: @user_subscription.type_of, user_id: @user_subscription.user_id }
    assert_redirected_to user_subscription_path(assigns(:user_subscription))
  end
