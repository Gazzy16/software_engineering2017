...
class SubscriptionUsersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create subscription_user" do
    assert_difference('SubscriptionUser.count') do
      post subscription_users_url, params: { subscription_user: { subscription_id: @subscription_user.subscription_id, user_id: @subscription_user.user_id, user_role: @subscription_user.user_role } }
    end
  ...
  test "should update subscription_user" do
    patch subscription_user_url(@subscription_user), params: { subscription_user: { subscription_id: @subscription_user.subscription_id, user_id: @subscription_user.user_id, user_role: @subscription_user.user_role } }
