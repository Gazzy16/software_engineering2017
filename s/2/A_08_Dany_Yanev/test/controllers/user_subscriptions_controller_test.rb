...
class UserSubscriptionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create user_subscription" do
    assert_difference('UserSubscription.count') do
      post user_subscriptions_url, params: { user_subscription: { subscription_id: @user_subscription.subscription_id, user_id: @user_subscription.user_id, user_type: @user_subscription.user_type } }
    end
  ...
  test "should update user_subscription" do
    patch user_subscription_url(@user_subscription), params: { user_subscription: { subscription_id: @user_subscription.subscription_id, user_id: @user_subscription.user_id, user_type: @user_subscription.user_type } }
