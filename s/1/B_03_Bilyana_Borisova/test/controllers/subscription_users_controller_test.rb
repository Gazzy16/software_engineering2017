...
class SubscriptionUsersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create subscription_user" do
    assert_difference('SubscriptionUser.count') do
      post subscription_users_url, params: { subscription_user: { sub_id: @subscription_user.sub_id, user_id: @subscription_user.user_id } }
    end
  ...
  test "should update subscription_user" do
    patch subscription_user_url(@subscription_user), params: { subscription_user: { sub_id: @subscription_user.sub_id, user_id: @subscription_user.user_id } }
