...
public class AsteroidsManager : MonoBehaviour {
    ...
    private void Start()
    {
        ...
        for (int i = 0; i < xSize; ++i)
        {
            ...
            {
                Vector3 cellOffset = new Vector3(i, 0, j) * playableGridCellSize + new Vector3(halfCellSize, 0, halfCellSize);
    ...
    void Update () {
        ...
        {
            // update asteroids movement forward
            asteroid.transform.position += asteroid.transform.rotation * (Vector3.forward * asteroidsSpeed * Time.deltaTime);
    ...
    private void RandomizeAsteroidTransform(GameObject asteroid)
    {
        ...
        if (freeCells.Count > 0)
        {
            ...
            asteroid.transform.rotation = Quaternion.Euler(new Vector3(0, Random.Range(0, 360), 0));
        }
    }
