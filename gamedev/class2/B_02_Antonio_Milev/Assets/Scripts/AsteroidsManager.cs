...
public class AsteroidsManager : MonoBehaviour {
    ...
    private void Start()
    {
        ...
        for(int i = 0;i < asteroidCount;++ i)
        {
            ...
            //newAsteroid.GetComponent<AsteroidController>().RadomizeDirection(newAsteroid.transform.position);
            Instantiate(newAsteroid, newAsteroid.transform.position, newAsteroid.transform.rotation);
        }
    }
