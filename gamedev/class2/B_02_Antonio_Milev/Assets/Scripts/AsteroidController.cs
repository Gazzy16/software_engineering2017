...
public class AsteroidController : MonoBehaviour {
    ...
    void Start()
    {
        ...
        GetComponent<Rigidbody>().angularVelocity = new Vector3(Random.Range(0f, 1f), 0, Random.Range(0f, 1f));
        StartCoroutine(Fire());
    }
    ...
    IEnumerator Fire()
    {
        while(true)
        {
            ...
            Instantiate(projectile, transform.position, Quaternion.Euler(0, Random.Range(0, 360), 0));
        }
    }
}
