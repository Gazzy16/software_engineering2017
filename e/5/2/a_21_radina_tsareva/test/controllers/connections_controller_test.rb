...
class ConnectionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create connection" do
    assert_difference('Connection.count') do
      post connections_url, params: { connection: { developer_id: @connection.developer_id, project_id: @connection.project_id } }
    end
  ...
  test "should update connection" do
    patch connection_url(@connection), params: { connection: { developer_id: @connection.developer_id, project_id: @connection.project_id } }
