...
class IndicesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create index" do
    assert_difference('Index.count') do
      post indices_url, params: { index: { ClassName: @index.ClassName, value: @index.value } }
    end
  ...
  test "should update index" do
    patch index_url(@index), params: { index: { ClassName: @index.ClassName, value: @index.value } }
