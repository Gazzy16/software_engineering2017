...
class ProgramsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create program" do
    assert_difference('Program.count') do
      post programs_url, params: { program: { Id_of_process: @program.Id_of_process, Name: @program.Name } }
    end
  ...
  test "should update program" do
    patch program_url(@program), params: { program: { Id_of_process: @program.Id_of_process, Name: @program.Name } }
