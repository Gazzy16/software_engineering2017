...
class ThreaddsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create threadd" do
    assert_difference('Threadd.count') do
      post threadds_url, params: { threadd: { ..: @threadd..., classname: @threadd.classname, value: @threadd.value } }
    end
  ...
  test "should update threadd" do
    patch threadd_url(@threadd), params: { threadd: { ..: @threadd..., classname: @threadd.classname, value: @threadd.value } }
