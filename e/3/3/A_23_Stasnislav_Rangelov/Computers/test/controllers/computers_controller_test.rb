...
class ComputersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create computer" do
    assert_difference('Computer.count') do
      post computers_url, params: { computer: { bran: @computer.bran, color: @computer.color, processor: @computer.processor, room_id: @computer.room_id } }
    end
  ...
  test "should update computer" do
    patch computer_url(@computer), params: { computer: { bran: @computer.bran, color: @computer.color, processor: @computer.processor, room_id: @computer.room_id } }
