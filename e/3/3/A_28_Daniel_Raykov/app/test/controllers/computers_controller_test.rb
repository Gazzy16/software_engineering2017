...
class ComputersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create computer" do
    assert_difference('Computer.count') do
      post computers_url, params: { computer: { brand: @computer.brand, color: @computer.color, processor: @computer.processor, roomid: @computer.roomid } }
    end
  ...
  test "should update computer" do
    patch computer_url(@computer), params: { computer: { brand: @computer.brand, color: @computer.color, processor: @computer.processor, roomid: @computer.roomid } }
