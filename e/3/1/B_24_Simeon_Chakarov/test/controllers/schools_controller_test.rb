...
class SchoolsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create school" do
    assert_difference('School.count') do
      post schools_url, params: { school: { school_id: @school.school_id, school_name: @school.school_name } }
    end
  ...
  test "should update school" do
    patch school_url(@school), params: { school: { school_id: @school.school_id, school_name: @school.school_name } }
