class MySchoolsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @my_school.save
        ...
        format.json { render :show, status: :created, location: @my_school }
      else
  ...
  def update
    respond_to do |format|
      if @my_school.update(my_school_params)
        ...
        format.json { render :show, status: :ok, location: @my_school }
      else
  ...
  def destroy
    @my_school.destroy
    respond_to do |format|
      format.html { redirect_to my_schools_url, notice: 'My school was successfully destroyed.' }
  ...
  private
    ...
    def my_school_params
      params.require(:my_school).permit(:school_name, :school_number)
    end
end
