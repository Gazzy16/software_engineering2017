...
class ComputersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create computer" do
    assert_difference('Computer.count') do
      post computers_url, params: { computer: { architecture: @computer.architecture, manufactured: @computer.manufactured, model: @computer.model, number: @computer.number } }
    end
  ...
  test "should update computer" do
    patch computer_url(@computer), params: { computer: { architecture: @computer.architecture, manufactured: @computer.manufactured, model: @computer.model, number: @computer.number } }
