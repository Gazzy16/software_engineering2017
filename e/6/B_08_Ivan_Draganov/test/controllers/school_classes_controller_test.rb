...
class SchoolClassesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create school_class" do
    assert_difference('SchoolClass.count') do
      post school_classes_url, params: { school_class: { class_teacher_id: @school_class.class_teacher_id, day: @school_class.day } }
    end
  ...
  test "should update school_class" do
    patch school_class_url(@school_class), params: { school_class: { class_teacher_id: @school_class.class_teacher_id, day: @school_class.day } }
