...
class TeacherClassesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create teacher_class" do
    assert_difference('TeacherClass.count') do
      post teacher_classes_url, params: { teacher_class: { teacher_classID: @teacher_class.teacher_classID, teacher_id: @teacher_class.teacher_id } }
    end
  ...
  test "should update teacher_class" do
    patch teacher_class_url(@teacher_class), params: { teacher_class: { teacher_classID: @teacher_class.teacher_classID, teacher_id: @teacher_class.teacher_id } }
