...
class SchoolsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create school" do
    assert_difference('School.count') do
      post schools_url, params: { school: { school: @school.school, teacher_id: @school.teacher_id } }
    end
  ...
  test "should update school" do
    patch school_url(@school), params: { school: { school: @school.school, teacher_id: @school.teacher_id } }
