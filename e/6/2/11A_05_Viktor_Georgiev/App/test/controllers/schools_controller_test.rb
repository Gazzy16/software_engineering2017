...
class SchoolsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create school" do
    assert_difference('School.count') do
      post schools_url, params: { school: { schoolday: @school.schoolday, teacherid: @school.teacherid } }
    end
  ...
  test "should update school" do
    patch school_url(@school), params: { school: { schoolday: @school.schoolday, teacherid: @school.teacherid } }
