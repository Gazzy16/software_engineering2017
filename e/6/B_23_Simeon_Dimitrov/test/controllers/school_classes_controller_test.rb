...
class SchoolClassesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create school_class" do
    assert_difference('SchoolClass.count') do
      post school_classes_url, params: { school_class: { day: @school_class.day, id: @school_class.id, school_class: @school_class.school_class, teacher: @school_class.teacher } }
    end
  ...
  test "should update school_class" do
    patch school_class_url(@school_class), params: { school_class: { day: @school_class.day, id: @school_class.id, school_class: @school_class.school_class, teacher: @school_class.teacher } }
