...
class SpecialitiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create speciality" do
    assert_difference('Speciality.count') do
      post specialities_url, params: { speciality: { name: @speciality.name, school_id: @speciality.school_id, students: @speciality.students } }
    end
  ...
  test "should update speciality" do
    patch speciality_url(@speciality), params: { speciality: { name: @speciality.name, school_id: @speciality.school_id, students: @speciality.students } }
