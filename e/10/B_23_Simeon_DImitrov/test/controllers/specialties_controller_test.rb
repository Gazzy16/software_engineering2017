...
class SpecialtiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create specialty" do
    assert_difference('Specialty.count') do
      post specialties_url, params: { specialty: { name: @specialty.name, school_id: @specialty.school_id, studnum: @specialty.studnum } }
    end
  ...
  test "should update specialty" do
    patch specialty_url(@specialty), params: { specialty: { name: @specialty.name, school_id: @specialty.school_id, studnum: @specialty.studnum } }
