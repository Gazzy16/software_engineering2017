...
class BottlesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create bottle" do
    assert_difference('Bottle.count') do
      post bottles_url, params: { bottle: { Table_id: @bottle.Table_id, brand: @bottle.brand, color: @bottle.color } }
    end
  ...
  test "should update bottle" do
    patch bottle_url(@bottle), params: { bottle: { Table_id: @bottle.Table_id, brand: @bottle.brand, color: @bottle.color } }
