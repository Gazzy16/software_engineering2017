...
class TablesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create table" do
    assert_difference('Table.count') do
      post tables_url, params: { table: { table_height: @table.table_height, table_width: @table.table_width } }
    end
  ...
  test "should update table" do
    patch table_url(@table), params: { table: { table_height: @table.table_height, table_width: @table.table_width } }
