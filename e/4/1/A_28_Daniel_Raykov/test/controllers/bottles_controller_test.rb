...
class BottlesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create bottle" do
    assert_difference('Bottle.count') do
      post bottles_url, params: { bottle: { brand: @bottle.brand, color: @bottle.color, tableid: @bottle.tableid } }
    end
  ...
  test "should update bottle" do
    patch bottle_url(@bottle), params: { bottle: { brand: @bottle.brand, color: @bottle.color, tableid: @bottle.tableid } }
