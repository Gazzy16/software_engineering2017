...
class CinemasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cinema" do
    assert_difference('Cinema.count') do
      post cinemas_url, params: { cinema: { id_sinema: @cinema.id_sinema, location: @cinema.location } }
    end
  ...
  test "should update cinema" do
    patch cinema_url(@cinema), params: { cinema: { id_sinema: @cinema.id_sinema, location: @cinema.location } }
