...
class CinemaFilmsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cinema_film" do
    assert_difference('CinemaFilm.count') do
      post cinema_films_url, params: { cinema_film: { location: @cinema_film.location, name: @cinema_film.name } }
    end
  ...
  test "should update cinema_film" do
    patch cinema_film_url(@cinema_film), params: { cinema_film: { location: @cinema_film.location, name: @cinema_film.name } }
