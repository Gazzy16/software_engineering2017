...
class CinemasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cinema" do
    assert_difference('Cinema.count') do
      post cinemas_url, params: { cinema: { film_id: @cinema.film_id, location: @cinema.location } }
    end
  ...
  test "should update cinema" do
    patch cinema_url(@cinema), params: { cinema: { film_id: @cinema.film_id, location: @cinema.location } }
