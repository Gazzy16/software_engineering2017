...
class SchoolTeachersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create school_teacher" do
    assert_difference('SchoolTeacher.count') do
      post school_teachers_url, params: { school_teacher: { school_id: @school_teacher.school_id, teacher_id: @school_teacher.teacher_id } }
    end
  ...
  test "should update school_teacher" do
    patch school_teacher_url(@school_teacher), params: { school_teacher: { school_id: @school_teacher.school_id, teacher_id: @school_teacher.teacher_id } }
