...
class ConnectsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create connect" do
    assert_difference('Connect.count') do
      post connects_url, params: { connect: { school_id: @connect.school_id, teacher_id: @connect.teacher_id } }
    end
  ...
  test "should update connect" do
    patch connect_url(@connect), params: { connect: { school_id: @connect.school_id, teacher_id: @connect.teacher_id } }
