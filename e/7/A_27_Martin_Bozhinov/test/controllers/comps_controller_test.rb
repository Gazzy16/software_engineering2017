...
class CompsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create comp" do
    assert_difference('Comp.count') do
      post comps_url, params: { comp: { address: @comp.address, name: @comp.name, number: @comp.number } }
    end
  ...
  test "should update comp" do
    patch comp_url(@comp), params: { comp: { address: @comp.address, name: @comp.name, number: @comp.number } }
